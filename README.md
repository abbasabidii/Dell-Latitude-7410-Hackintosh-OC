...
- Reboot and you will have HiDPI at 1600x900 resolution <br>
  ...
  :warning: Using `1600x900` HiDPI resolution in macOS Tahoe will cause performance issues and sluggishness because Tahoe is a GPU hog, instead use `1366x768` its slightly zoomed but its snappier and if you want absolute performance and smoothness use macOS Sequoia
